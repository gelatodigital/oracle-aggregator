...
async function main() {
  if (network.name == 'mainnet') {
    console.log('for safety mainnet deployment is disallowed by default\nsee scripts/deploy.js to allow')
    return
  }
  ...
  const GelatoOracleAggregator = await ethers.getContractFactory("OracleAggregator", deployer);
